      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={isEdit ? "Editar Artigo" : "Novo Artigo"}>
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            <input type="checkbox" id="postActive" checked={editing.active} onChange={(e) => setEditing({ ...editing, active: e.target.checked })} className="w-4 h-4 rounded accent-[#012D76]" />
